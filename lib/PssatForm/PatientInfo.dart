...
//  final List<String> _birthOrder = <String>['First', 'Second', 'Third', 'Fourth', 'Fifth', 'Sixth'];
  ...
  String _validateBirthWeight(String value) {
    ...
    final RegExp numExp = new RegExp(r'(?!^0*$)(?!^0*\.0*$)^\d{1,2}(\.\d{1,2})?$');
  ...
  void _handleSubmitted() {
    ...
    if (!form.validate()){
      ...
      final snackbar = new SnackBar(content: new Text('Please re-enter field that marked in red'),);
      ...
      showDialog(
          context: context,
          child: new AlertDialog(
            content: new Text("Are you sure to submit this patient's information?"),
            actions: <Widget>[
              new RaisedButton(
              ...
              new RaisedButton(
                  ...
                  onPressed: () {
                    showDialog(
                        context: context,
                        child: new AlertDialog(
                          content: new Text('Patient information saved successfully!'),
                          actions: <Widget>[
                            new RaisedButton(
                                child: new Text("OK"),
                                onPressed: () {
...
//              initialValue: patient.birthWeight,
            ...
            // Birth order
            new TextFormField(
//              initialValue: patient.birthOrder,
              decoration: const InputDecoration(
            ...
            new TextFormField(
              ...
              onSaved: (String value){patient.resuscitationMeds = value;},
              maxLines: 2,
            ...
            new TextFormField(
              ...
              onSaved: (String value){patient.otherMeds = value;},
              maxLines: 2,
              keyboardType: TextInputType.multiline,
            ),
            ...
            new Container(
                ...
                child: new Column(
                  children: <Widget>[
                    new Container(
                      child: new Text('Apgar', style: Theme.of(context).textTheme.button),
